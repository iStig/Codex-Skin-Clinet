...
# Codex 26.707+ uses the generic process name ChatGPT. Match the executable
# inside the com.openai.codex bundle so another ChatGPT app cannot block an update.
if codex_process_is_running; then CODEX_RUNNING="true"; fi
